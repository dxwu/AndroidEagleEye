...
import edu.dartmouth.dwu.myxposedmodule.Tutorial;
...
public class ContextImplHook extends MethodHook {
	...
	public void after(MethodHookParam param) throws Throwable {
		...
		if (mMethod == Methods.getPackageManager) {
			...
			if (instance != null)
				Tutorial.hookSystemServices(this, "PackageManager", instance);
			return;
			...
			if (param.args.length > 0 && param.args[0] != null) {
				...
				if (name != null && instance != null)
					Tutorial.hookSystemServices(this, name, instance);
			}
			return;
